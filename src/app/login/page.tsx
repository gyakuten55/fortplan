...
export default function LoginPage() {
  ...
  const handleDemoLogin = () => {
    ...
    setMessage('デモアカウントの情報が入力されました。ログインボタンを押してください。');
  };
        ...
        <div className="glass-card p-8 rounded-lg">
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full border border-purple-400 text-purple-400 py-3 rounded-lg font-semibold hover:bg-purple-400 hover:text-white transition-colors"
            >
              デモアカウントでログイン
            </button>
          </div>
          ...
          <div className="mt-8 p-4 bg-white/5 rounded-lg border border-white/10">
            <h3 className="text-sm font-semibold text-purple-300 mb-2">デモアカウント情報</h3>
            <div className="text-xs text-gray-400 space-y-1">
              <p>メール: demo@fortplan.com</p>
              <p>パスワード: password123</p>
              <p className="mt-2 text-yellow-400">
                ※デモアカウントでは全機能をお試しいただけます
              </p>
            </div>
          </div>
        </div>
